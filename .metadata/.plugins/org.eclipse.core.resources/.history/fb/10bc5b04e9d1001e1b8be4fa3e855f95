...
public class IndexController {
	...
	public String showIndex(Model model,
	                       @RequestParam(required = false) Integer selectedBuildingId,
	                       @RequestParam(required = false) Integer selectedRoomId) {
	    ...
	    if (selectedBuildingId != null) {
	        rooms = roomsRepository.findAllByBuildingId(selectedBuildingId);
	        System.out.println("Rooms: " + rooms);

	        if (selectedRoomId != null) {
	            selectedRoom = roomsRepository.findRoomWithFacilitiesAndStructuralFeatures(selectedRoomId);
	        }
	    }
